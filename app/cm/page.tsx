      ...
      <div className="min-h-screen bg-gray-50">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="mt-4">
                          <div className="flex items-center justify-between mb-3">
                            <h3 className="text-sm font-medium text-gray-700">Additional Fees</h3>
                            <button
                              type="button"
                              onClick={addAdditionalFee}
                              disabled={additionalFees.length >= 4}
                              className="flex items-center space-x-1 px-3 py-1.5 text-xs bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors duration-200"
                            >
                                ...
                                <div key={fee.id} className="bg-gray-50 rounded-lg p-3">
                                  <div className="flex items-center space-x-2">
                                    ...
                                    <div className="flex space-x-1">
                                      <button
                                        type="button"
                                        onClick={() => handleAdditionalFeeChange(fee.id, 'feeType', 'fee')}
                                        className={`px-2 py-1 text-xs rounded border transition-colors duration-200 ${
                                          fee.feeType === 'fee'
                                            ? 'bg-purple-600 text-white border-purple-600'
                                            : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'
                                      ...
                                      <button
                                        type="button"
                                        onClick={() => handleAdditionalFeeChange(fee.id, 'feeType', 'percentage')}
                                        className={`px-2 py-1 text-xs rounded border transition-colors duration-200 ${
                          ...
                          {/* Custom Fee Field */}
                          <div className="mt-4">
                            <label htmlFor="customFeeName" className="block text-sm font-medium text-gray-700 mb-2">
                              Custom Fee
                            </label>
                            <textarea
                              id="customFeeName"
                        ...
                        <div className="mt-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                          <h3 className="text-sm font-medium text-gray-700 mb-4">Processing Fees</h3>
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                              <label htmlFor="applicationFees" className="block text-sm font-medium text-gray-700 mb-2">
                                Application Fees (Non-adjustable)
                              </label>
                            ...
                            <div>
                              <label htmlFor="sanctioningFees" className="block text-sm font-medium text-gray-700 mb-2">
                                Sanctioning Fees (Adjustable)
                              </label>
                              <div className="relative">
                                <input
                                  type="number"
        ...
        <PDFPreviewModal
          ...
          mandateData={{
            ...
            applicationFees: formData.applicationFees,
            sanctioningFees: formData.sanctioningFees,
            additionalFees: additionalFees,
            customFeeName: formData.customFeeName
          }}
